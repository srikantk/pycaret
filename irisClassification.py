...
def get_model():
  return load_model('savedModels/classification_model')
...
of the PyCaret classification module, based on Streamlit.")

form=st.form("species")
sepal_length=form.slider('SepalLength',min_value=0.0,max_value=10.0, value=0.0, step = 0.1, format = '%f')
sepal_width=form.slider('SepalWidth',min_value=0.0,max_value=10.0, value=0.0, step = 0.1, format = '%f')
petal_length=form.slider('PetalLength',min_value=0.0,max_value=10.0, value=0.0, step = 0.1, format = '%f')
petal_width=form.slider('PetalWidth',min_value=0.0,max_value=10.0, value=0.0, step = 0.1, format = '%f')
